...
Text headingMediumText(BuildContext context, String heading){
  return Text(heading,textAlign: TextAlign.center,style: headingMd.copyWith(color: isDarkMode(context) ? ColorResources.white : ColorResources.grey),);
}
...
Text paragraphMediumText(BuildContext context, String heading){
  return Text(heading,textAlign: TextAlign.center,style: paragraphMd.copyWith(color: getColor(context, ColorResources.secondaryColorDark, ColorResources.secondaryColorDark)),);
}
...
Text displayLargeTextColor(BuildContext context, String heading){
  return Text(heading,style: displayLg.copyWith(fontWeight: FontWeight.w800,color: ColorResources.secondaryColorLight,),);
}


Text largeText(BuildContext context, String heading){
  return Text(heading,textAlign: TextAlign.center,style: textLg.copyWith(color: ColorResources.
  white,fontWeight: FontWeight.w700,));
}


Text mediumDisplayText(BuildContext context, String heading){
  return Text(heading,textAlign: TextAlign.center,style: displayMd.copyWith(color: ColorResources.white,fontWeight: FontWeight.w700,));
}

textColor(BuildContext context) => getColor(context, ColorResources.white, ColorResources.grey);
